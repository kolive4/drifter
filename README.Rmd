...
```{r maine coast, warning=FALSE, message=FALSE, echo=FALSE}
...
```{r chandler cove, warning=FALSE, message=FALSE, echo=FALSE}
chcv = get_bbox("chcv")
sf::sf_use_s2(F)
...
```{r deep cove 1, warning=FALSE, message=FALSE, echo=FALSE}
...
```{r deep cove 2, warning=FALSE, message=FALSE, echo=FALSE}
